...
const Header = () => {
  ...
  return (
    <header className={'header'}>
      ...
      <nav
        className={`header__nav header-nav ${active ? 'header-nav_active' : ''}`}
      >
        <BurgerMenu callback={toggleMobileMenuShow} active={active} />
        ...
        <div className="header-nav__right">
          <NavLink to={'/auth/login'} className="header-nav__profile">
            <ProfileIcon />
          </NavLink>
        </div>
      </nav>
