  ...
  return (
    ...
    >
      ...
      <div className="authTemplate-form__fields">
        ...
        <Input name="pass" type="password" input={password}>
          Пароль
        </Input>
        <Input name="passRep" type="password" input={repPassword}>
          Повторите пароль
        </Input>
      </div>
      <Button type={'main'}>
        <Title type={'bright'} level={4}>
          Зарегистрировать
        </Title>
      </Button>
      <Link to={'/auth/login'}>
        <Paragraph type={'default'} level={5}>
          Есть аккаунт ? Войти
        </Paragraph>
      </Link>
    </form>
