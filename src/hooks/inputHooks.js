      ...
      switch (validation) {
        ...
        case 'cyrillicError':
          ...
          if (value.match(cyrillicRegex)) {
            ...
            tempErrs['cyrillicError'] =
              `Поле должно содержать только символы кириллицы, пробелы и дефисы`;
            setErrors(tempErrs);
          }
          break;
        case 'isFcs':
        ...
        case 'passEqual':
          ...
          if (value === validations[validation]) {
            ...
            tempErrs['passEqual'] = `Пароли должны совпадать`;
            setErrors(tempErrs);
          }
          break;
        default:
